...
connection.query("CREATE TABLE IF NOT EXISTS Planet("+
  "PID INT AUTO_INCREMENT,"+
  "planet_name VARCHAR(20),"+
  "x_size INT,"+
  "y_size INT,"+
  "PRIMARY KEY(PID));");
connection.query("CREATE TABLE IF NOT EXISTS Robot("+
...
connection.query("CREATE TABLE IF NOT EXISTS PlanetData("+
  ...
  "temp DOUBLE,"+
  "ground ENUM('NICHTS','SAND','GEROELL','FELS','WASSER','PFLANZEN','MORAST','LAVA'),"+
  "x_pos INT,"+
  "y_pos INT,PRIMARY KEY(DID),"+
  "FOREIGN KEY(PID) REFERENCES Planet(PID));");
